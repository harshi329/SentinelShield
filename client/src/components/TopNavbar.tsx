  ...
  return (
    <header className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 px-4 py-3 bg-white/80 dark:bg-slate-950/60 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        {/* System active badge - hidden on very small screens */}
        <div className="hidden xs:flex items-center gap-1.5 rounded-full bg-green-500/10 px-2.5 py-1.5 text-xs text-green-500 dark:text-green-400">
